...
/** Coin symbol URL param: 1–10 uppercase alphanumeric characters. */
export const SymbolParamSchema = z
  .string()
  .regex(/^[A-Z0-9]{1,10}$/, "Invalid coin symbol");

/** Post id URL param: must be a positive integer (coerced from string). */
