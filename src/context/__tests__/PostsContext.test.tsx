...
async function getMocks() {
  ...
  // The mock object is defined in the vi.mock factory above; we access _mocks
  // via a typed interface to avoid unsafe any usage.
  ...
  return (supabase as unknown as MockedSupabase)._mocks;
}
...
describe("PostsContext", () => {
  ...
  it("addToWatchlist clears a previous error before a new createPost", async () => {
    ...
    await act(async () => {
      ...
      if (!capturedCtx) throw new Error("context was not captured");
      try {
