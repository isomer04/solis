    ...
    <div className="container mx-auto max-w-7xl px-4 pt-6 pb-12">
      ...
      {loading ? (
        ...
        <>
          ...
          {hero && (() => {
            const heroHref = safeHref(hero.url);
            const heroCard = (
            ...
            return heroHref ? (
              ...
              <div className="block mb-8 card bg-base-100 shadow-lg overflow-hidden">
                {heroCard}
              </div>
            );
          })()}
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {rest.map((article) => {
              ...
              return articleHref ? (
                ...
                <div
                  key={article.id}
                  className="card bg-base-100 shadow overflow-hidden group"
                >
                  {articleCard}
                </div>
              );
